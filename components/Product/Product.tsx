...
export const Product = motion.create(forwardRef(({ product, className, ...props }: ProductProps, ref: ForwardedRef<HTMLDivElement>): ReactNode => {
    ...
    return (
        ...
        >
            <Card 
                color='blue' 
                className={styles.reviews} ref={reviewRef}
                >
